...
public class RegistrationPage {
   ...
   //поле Имя
    private By nameField = By.xpath(".//fieldset[1]/div/div/input[@class='text input__textfield text_type_main-default' and @name='name']");
    //поле Email
    private By emailField = By.xpath(".//fieldset[2]/div/div/input[@class='text input__textfield text_type_main-default' and @name='name']");
    //поле Пароль
    private By passwordField = By.xpath(".//fieldset[3]/div/div/input[@class='text input__textfield text_type_main-default' and @name='Пароль']");
    ...
    //элемент подтверждения успешной регистрации - кнопка Вход
